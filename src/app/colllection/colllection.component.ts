...
@Component({
  selector: 'app-colllection',
  standalone: true,
  imports: [CommonModule, RestaurantsComponent],
  templateUrl: './colllection.component.html',
  styleUrl: './colllection.component.scss'
})
export class ColllectionComponent implements OnInit, OnDestroy {
