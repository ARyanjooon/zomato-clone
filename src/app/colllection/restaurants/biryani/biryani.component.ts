...
export class BiryaniComponent {
  restaurant = {
    ...
    menu: [
      { name: 'Chicken Biryani', price: 220, description: 'Fragrant basmati rice cooked with tender chicken, spices, and saffron.', image: 'https://th.bing.com/th/id/OIP.JbBpts8DpTwg1253grV3YAHaHa?w=195&h=195&c=7&r=0&o=7&cb=ucfimg2&dpr=1.3&pid=1.7&rm=3&ucfimg=1' },
      ...
      { name: 'Raita', price: 50, description: 'Cool yogurt with cucumber, mint, and spices.', image: 'https://th.bing.com/th/id/OIP.QuNRUgF6QBWcx7AKdNXjnQHaEK?w=289&h=180&c=7&r=0&o=7&cb=ucfimg2&dpr=1.3&pid=1.7&rm=3&ucfimg=1' },
